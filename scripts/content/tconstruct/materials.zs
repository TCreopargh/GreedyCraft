...
fusion_matrix.addExtraMaterialStats(820);fusion_matrix.addBowMaterialStats(getDrawSpeed(1.2) as float, 1.2, 9.6);
...
infernium.addExtraMaterialStats(1024);infernium.addBowMaterialStats(getDrawSpeed(1.2) as float, 1.2, 12.4);
...
titanium.addExtraMaterialStats(40000);titanium.addBowMaterialStats(getDrawSpeed(1.2) as float, 1.3, 23.3);
...
cryonium.addExtraMaterialStats(800);cryonium.addBowMaterialStats(getDrawSpeed(1.2) as float, 1.3, 8.9);
...
alubrass.addExtraMaterialStats(850);alubrass.addBowMaterialStats(getDrawSpeed(1.65) as float, 1.3, 6.2);
...
diamond.addExtraMaterialStats(1250);diamond.addBowMaterialStats(getDrawSpeed(1.65) as float, 1.2, 7.0);
...
gold.addExtraMaterialStats(40);gold.addBowMaterialStats(getDrawSpeed(1.65) as float, 1.3, 6.2);
...
coal.addBowMaterialStats(getDrawSpeed(1.8) as float, 1.0, 0.1);coal.addProjectileMaterialStats();
coal.register();
...
ethaxium.addExtraMaterialStats(600);ethaxium.addBowMaterialStats(getDrawSpeed(1.35) as float, 1.3, 12.2);
...
scarlite.addBowMaterialStats(getDrawSpeed(1.5) as float, 1.0, 2.5);scarlite.addProjectileMaterialStats();
scarlite.register();
...
hephaestite.addBowMaterialStats(getDrawSpeed(1.3) as float, 1.0, 1.5);hephaestite.addProjectileMaterialStats();
...
mithrillium.addExtraMaterialStats(500);mithrillium.addBowMaterialStats(getDrawSpeed(0.8) as float, 1.0, 10);
...
adaminite.addExtraMaterialStats(800);adaminite.addBowMaterialStats(getDrawSpeed(0.7) as float, 1.2, 12);
...
mithminite.addExtraMaterialStats(4000);mithminite.addBowMaterialStats(getDrawSpeed(0.65) as float, 1.4, 18);
...
ravaging.addExtraMaterialStats(400);ravaging.addBowMaterialStats(getDrawSpeed(0.25) as float, 1.2, 0);
...
remorseful.addBowMaterialStats(getDrawSpeed(6) as float, 5.0, 23.5);remorseful.addProjectileMaterialStats();
remorseful.register();
...
gaia.addExtraMaterialStats(450);gaia.addBowMaterialStats(1.4, 1.2, 10);
...
cytosinite.addExtraMaterialStats(500);cytosinite.addBowMaterialStats(getDrawSpeed(0.8) as float, 1.1, 7.8);
...
terra_alloy.addExtraMaterialStats(6000);terra_alloy.addBowMaterialStats(getDrawSpeed(4) as float, 2, 34.0);
...
stellar_alloy.addExtraMaterialStats(320);stellar_alloy.addBowMaterialStats(getDrawSpeed(0.6) as float, 1, 1);
...
astral_metal.addExtraMaterialStats(900);astral_metal.addBowMaterialStats(getDrawSpeed(1) as float, 1.4, 11.0);
...
orichalcos.addExtraMaterialStats(1400);orichalcos.addBowMaterialStats(getDrawSpeed(1.4) as float, 1.3, 13.0);
...
yellorium.addExtraMaterialStats(240);yellorium.addBowMaterialStats(getDrawSpeed(1.5) as float, 1.2, 3.0);
...
chocolate.addExtraMaterialStats(30);chocolate.addBowMaterialStats(getDrawSpeed(3.0) as float, 1.0, 1.0);
...
cincinnasite.addBowMaterialStats(getDrawSpeed(1.8) as float, 1.4, 1.5);cincinnasite.addProjectileMaterialStats();
...
rime.addBowMaterialStats(getDrawSpeed(1.2) as float, 2.0, 3.5);rime.addProjectileMaterialStats();
rime.register();
...
ender_biotite.addBowMaterialStats(getDrawSpeed(1.4) as float, 1.5, 7.8);ender_biotite.addProjectileMaterialStats();
...
tofu_gem.addBowMaterialStats(getDrawSpeed(1.4) as float, 1.2, 1.8);tofu_gem.addProjectileMaterialStats();
tofu_gem.register();
...
strong_tofu_gem.addBowMaterialStats(getDrawSpeed(1.2) as float, 1.2, 2.8);strong_tofu_gem.addProjectileMaterialStats();
...
sakura_diamond.addBowMaterialStats(getDrawSpeed(1.1) as float, 1.2, 4);sakura_diamond.addProjectileMaterialStats();
...
mud.addBowMaterialStats(getDrawSpeed(1.5) as float, 1.0, 1);mud.addProjectileMaterialStats();
mud.register();
...
dimensional_shard.addBowMaterialStats(getDrawSpeed(1.2) as float, 1.2, 6);dimensional_shard.addProjectileMaterialStats();
...
heart_crystal.addBowMaterialStats(getDrawSpeed(1.1) as float, 1.2, 4);heart_crystal.addProjectileMaterialStats();
...
bedrock.addBowMaterialStats(getDrawSpeed(16) as float, 8, 150);bedrock.addProjectileMaterialStats();
bedrock.register();
...
aeroite.addExtraMaterialStats(200);aeroite.addBowMaterialStats(getDrawSpeed(0.7) as float, 6, 2);
...
asgardium.addExtraMaterialStats(600);asgardium.addBowMaterialStats(getDrawSpeed(1.5) as float, 1.2, 8);
...
shadowium.addExtraMaterialStats(1200);shadowium.addBowMaterialStats(getDrawSpeed(0.45) as float, 1.5, 4);
...
netherite.addExtraMaterialStats(1800);netherite.addBowMaterialStats(getDrawSpeed(5) as float, 1.4, 24.0);
...
seared.addExtraMaterialStats(120);seared.addBowMaterialStats(getDrawSpeed(1.6) as float, 1.1, 1.2);
...
scorched.addExtraMaterialStats(220);scorched.addBowMaterialStats(getDrawSpeed(1.4) as float, 1.2, 2.0);
...
meteor.addExtraMaterialStats(600);meteor.addBowMaterialStats(getDrawSpeed(3.6) as float, 2.8, 22.0);
...
chromium.addExtraMaterialStats(200);chromium.addBowMaterialStats(getDrawSpeed(1.4) as float, 1.2, 1.6);
...
stainless_steel.addExtraMaterialStats(1500);stainless_steel.addBowMaterialStats(getDrawSpeed(2.6) as float, 2.4, 15.6);
...
protonium.addExtraMaterialStats(6400);protonium.addBowMaterialStats(getDrawSpeed(12) as float, 5.0, 80);
...
electronium.addExtraMaterialStats(4200);electronium.addBowMaterialStats(getDrawSpeed(0.04) as float, 0.6, -20);
...
crimsonite.addExtraMaterialStats(760);crimsonite.addBowMaterialStats(getDrawSpeed(0.75) as float, 1.25, 4.5);
...
aqualite.addExtraMaterialStats(500);aqualite.addBowMaterialStats(getDrawSpeed(0.6) as float, 1.5, 2.6);
...
manganese.addExtraMaterialStats(200);manganese.addBowMaterialStats(getDrawSpeed(2.2) as float, 1.5, 3.6);
...
manganese_steel.addExtraMaterialStats(500);manganese_steel.addBowMaterialStats(getDrawSpeed(2.9) as float, 1.8, 7.6);
...
mithril.addExtraMaterialStats(280);mithril.addBowMaterialStats(getDrawSpeed(1.3) as float, 1.5, 2.5);
...
durasteel.addExtraMaterialStats(720);durasteel.addBowMaterialStats(getDrawSpeed(1.0) as float, 1.5, 6.0);
...
aeonsteel.addExtraMaterialStats(1280);aeonsteel.addBowMaterialStats(getDrawSpeed(2.2) as float, 1.75, 14);
...
chromasteel.addExtraMaterialStats(4240);chromasteel.addBowMaterialStats(getDrawSpeed(0.5) as float, 1.25, 4.5);
...
spectre.localizedName = "通灵";
spectre.addHeadMaterialStats(1400, 10.2, 8.0, 4);
spectre.addHandleMaterialStats(1.2, 500);
spectre.addExtraMaterialStats(640);spectre.addBowMaterialStats(getDrawSpeed(1.5) as float, 1.0, 2.5);
spectre.addProjectileMaterialStats();
spectre.addCoreMaterialStats(1000, 23.3);
spectre.addPlatesMaterialStats(2, 400, 2);
spectre.addTrimMaterialStats(600);
spectre.register();
...
spectre_string.localizedName = "通灵线";
...
terrestrial.addBowMaterialStats(getDrawSpeed(1.2) as float, 3.2, 16.4);terrestrial.addProjectileMaterialStats();
...
alpha_fur.addBowMaterialStats(getDrawSpeed(1.0) as float, 0.3, 1.0);alpha_fur.addProjectileMaterialStats();
alpha_fur.register();
...
perfect.addBowMaterialStats(getDrawSpeed(1.0) as float, 2.0, 5.0);perfect.addProjectileMaterialStats();
perfect.register();
...
pumpkin.addBowMaterialStats(getDrawSpeed(1.4) as float, 1.2, 1.4);pumpkin.addProjectileMaterialStats();
pumpkin.register();
...
poop.addBowMaterialStats(getDrawSpeed(1.1) as float, 4.5, 1.4);poop.addProjectileMaterialStats();
poop.register();
