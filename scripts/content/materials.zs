...
val manganese = mods.contenttweaker.tconstruct.MaterialBuilder.create("manganese");
...
val manganese_steel = mods.contenttweaker.tconstruct.MaterialBuilder.create("manganese_steel");
...
manganese_steel.addHeadMaterialStats(2200, 17.0, 7.6, 3);
