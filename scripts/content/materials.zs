...
game.setLocalization("fluid.ravaging", "毁灭流质");
...
remorseful.addBowMaterialStats(4, 5.0, 23.5);
...
terra_alloy.addHeadMaterialStats(262144, 21.6, 38.6, 10);
...
game.setLocalization("fluid.cosmilite", "寰宇超流体");
...
cosmilite.addHeadMaterialStats(1048576, 53.6, 85, 12);
cosmilite.addHandleMaterialStats(64, 131072);
cosmilite.addExtraMaterialStats(262144);
cosmilite.addMaterialTrait("duritos", "head");
cosmilite.addMaterialTrait("duritos", "handle");
cosmilite.addMaterialTrait("duritos", "extra");
cosmilite.addBowMaterialStats(0.32, 3, 38.0);
...
game.setLocalization("fluid.astral_metal", "星辰涌流");
...
astral_metal.addHeadMaterialStats(13600, 17.6, 23, 6);
...
astral_metal.addBowMaterialStats(1, 1.4, 11.0);
...
game.setLocalization("fluid.orichalcos", "熔融奥利哈钢");
...
orichalcos.addHeadMaterialStats(14200, 15.6, 23.2, 7);
...
orichalcos.addBowMaterialStats(1.4, 1.3, 13.0);
...
yellorium.addBowMaterialStats(1.5, 1.2, 3.0);
...
chocolate.addBowMaterialStats(3.0, 1.0, 1.0);
...
cincinnasite.addBowMaterialStats(1.8, 1.4, 1.5);
...
rime.addBowMaterialStats(1.2, 2.0, 3.5);
...
ender_biotite.addBowMaterialStats(1.4, 1.5, 7.8);
...
tofu_gem.addBowMaterialStats(1.4, 1.2, 1.8);
...
strong_tofu_gem.addBowMaterialStats(1.2, 1.2, 3.8);
...
sakura_diamond.addBowMaterialStats(1.1, 1.2, 4);
...
mud.addBowMaterialStats(1.5, 1.0, 1);
...
dimensional_shard.addBowMaterialStats(1.2, 1.2, 6);
...
heart_crystal.addBowMaterialStats(1.1, 1.2, 4);
...
bedrock.addHeadMaterialStats(120000, 33.4, 28.2, 10);
bedrock.addHandleMaterialStats(5, 122000);
bedrock.addExtraMaterialStats(160000);
bedrock.addBowMaterialStats(16, 8, 150);
...
poop.addBowMaterialStats(1.1, 4.5, 1.4);
