...
val alloyRecipes as ILiquidStack[][ILiquidStack] = {
    ...
    <liquid:fluxed_electrum> * 288 : [<liquid:gold> * 144, <liquid:silver> * 144, <liquid:redstone> * 1000],
    ...
    <liquid:end_steel> * 2 : [<liquid:obsidian> * 2, <liquid:dark_steel> * 2, <liquid:ender> * 1],
