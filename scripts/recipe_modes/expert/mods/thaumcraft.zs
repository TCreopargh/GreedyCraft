...
Infusion.registerRecipe("crimsonite_ingot", "", <additions:crimsonite_ingot> * 2, 8, [<aspect:victus> * 10, <aspect:mortuus> * 10, <aspect:aversio> * 10, <aspect:desiderium> * 10], <ore:ingotBloodInfusedIron>, [<bloodarsenal:blood_diamond:3>, <ore:ingotThaumium>, <bloodarsenal:blood_diamond:3>, <ore:ingotThaumium>]);
