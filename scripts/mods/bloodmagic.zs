...
BloodAltar.addRecipe(<tconevo:metal:25>, <additions:stainless_steel_ingot>, 2, 10000, 200, 200);
BloodAltar.addRecipe(<bloodmagic:blood_shard:1>, <bloodmagic:blood_shard>, 3, 20000, 200, 200);
