...
val tooltipMap as string[][IIngredient] = {
    ...
    <astralsorcery:blockaltar> : [game.localize("greedycraft.tooltip.astralsorcery.blockaltar.1")],
    <astralsorcery:blockaltar> : [game.localize("greedycraft.tooltip.astralsorcery.blockaltar.1")],
	...
	<modularmachinery:blockcasing:2> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.1"), machinery_upgrade_guide],
	<modularmachinery:blockcasing:3> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.1"), machinery_upgrade_guide],
	<modularmachinery:blockcasing:5> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.1"), machinery_upgrade_guide],
