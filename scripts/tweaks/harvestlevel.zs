...
<item:minecraft:end_portal_frame>.asBlock().definition.hardness = 200.0 as float;
<item:minecraft:end_portal_frame>.asBlock().definition.setHarvestLevel("pickaxe", 8);
